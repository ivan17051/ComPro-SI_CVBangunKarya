...
@section('content2')
    <div class="row">
        <div class="col text-center" style="margin-top: 4.7rem;">
            <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#exampleModal" style="position:absolute; left:30px; top:35px;">Tambah<i class="fa fa-plus" style="margin-left: 5px;"></i></button>
            <h1 style="margin-top:30px;">Gallery</h1>
        </div>
    </div>
