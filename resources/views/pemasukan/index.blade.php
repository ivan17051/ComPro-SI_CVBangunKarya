...
@section('content2')
    ...
    <div class="col-md-12 search-table-col">
        <div class="form-group pull-right col-lg-4"><input type="text" class="search form-control" placeholder="Search by typing here.."></div><span class="counter pull-right"></span><a href="/pemasukan/create"><button class="btn btn-primary" type="button">Tambah<i class="fa fa-plus" style="margin-left: 5px;"></i></button></a>
            ...
            <table class="table table-bordered table-hover">
                ...
                @foreach($pemasukan as $unit)
                    <tr>
                        ...
                        <td>{{ $unit->kategori }}</td>
                        <td>{{ $unit->jumlah_pemasukan_klien }}</td>
                        <td>
                            <div class="row">
                                <div class="col-sm" style="padding-left:12px; padding-right:2px;">
                                    <form action="/pemasukan/{{ $unit->id }}" method="GET">
                                ...
                                <div class="col-sm" style="padding-left:2px; padding-right:2px;">
                                    <form action="/pemasukan/edit/{{ $unit->id }}" method="GET">
                                        @csrf
                                ...
                                <div class="col-sm" style="padding-right:15px; padding-left:2px;">
                                    <form action="/pemasukan/{{ $unit->id }}" method="POST">
                                        @csrf
                                        @method('DELETE')
